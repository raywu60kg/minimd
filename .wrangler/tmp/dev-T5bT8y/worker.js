...
// .wrangler/tmp/bundle-FWdjqF/checked-fetch.js
      ...
      switch (request.method) {
        ...
        case "POST":
          if (path === "notes") {
            ...
            ).bind(body.title, body.content, now).all();
...
// .wrangler/tmp/bundle-FWdjqF/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-FWdjqF/middleware-loader.entry.ts
